...
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.88\textwidth]{images/exploded_iso.png}
...
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.88\textwidth]{images/exploded_side.png}
...
รูปที่~\ref{fig:cad_assembly} แสดง CAD Assembly
ของระบบเชิงกลทั้งหมด โดยมีมิติหลักได้แก่
ฐาน 200$\times$200\,mm และรัศมีการทำงาน 500\,mm

% [รูป CAD Assembly 3D]
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.85\textwidth]{images/cad_assembly_3d.png}
%   \caption{CAD Assembly ของระบบเชิงกล
%            แสดงชิ้นส่วนหลักทั้งหมด}
...
รายละเอียด Drawing แต่ละชิ้นส่วนแสดงใน
Appendix~\ref{app:drawings}
...
\subsubsection{ผลการตรวจสอบขนาดจริง}
\label{subsubsec:dimension_verification}

\begin{table}[H]
  \centering
  \caption{ผลการตรวจสอบขนาดชิ้นส่วนจริง}
  \label{tab:mech_inspection}
  \begin{tabular}{llcccl}
    \toprule
    ชิ้นส่วน & พารามิเตอร์ & ค่าออกแบบ & ค่าจริง & Tolerance & ผล \\
    \midrule
    Base Plate        & ขนาดฐาน (mm$^2$) & 200$\times$200 & [VAL] & $\pm$1\,mm & [P/F] \\
    Rotating Arm      & ความยาว (mm)     & 500            & [VAL] & $\pm$1\,mm & [P/F] \\
    Azimuth Joint     & $\diameter$ เพลา (mm) & 17        & [VAL] & $\pm$0.1\,mm & [P/F] \\
    End Effector      & $\diameter$ รู (mm)   & 14        & [VAL] & $\pm$0.1\,mm & [P/F] \\
    Encoder Housing   & $\diameter$ รู (mm)   & 8         & [VAL] & $\pm$0.1\,mm & [P/F] \\
    Proximity Sensor  & $\diameter$ รู (mm)   & 12        & [VAL] & $\pm$0.5\,mm & [P/F] \\
    \bottomrule
  \end{tabular}
\end{table}
