...
\usepackage{amssymb}
\usepackage{amsfonts}
\usepackage[nointegrals]{wasysym} % Support for \diameter
\usepackage{longtable}           % Support for tables spanning multiple pages
...
\input{sections/02_design.tex}
\input{sections/03_implementation.tex}
\input{sections/04_integration.tex}
\input{sections/05_test_results.tex}
\input{sections/06_verification.tex}
